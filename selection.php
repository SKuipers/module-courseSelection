...
if (isActionAccessible($guid, $connection2, '/modules/Course Selection/selection.php') == false) {
    ...
    if ($highestGroupedAction == 'Course Selection_all') {
        ...
        $row = $form->addRow();
            ...
            $row->addSelectStudent('gibbonPersonIDStudent', $_SESSION[$guid]['gibbonSchoolYearID'], array('allStudents' => true, 'byName' => true, 'showRoll' => true))->selected($gibbonPersonIDStudent);
