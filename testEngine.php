...
use Gibbon\Modules\CourseSelection\Timetable\Engine;
use Gibbon\Modules\CourseSelection\Timetable\EngineSettings;
...
$engine = new Engine($timetableGateway, $engineSettings);
